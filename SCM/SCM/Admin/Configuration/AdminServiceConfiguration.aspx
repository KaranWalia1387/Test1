<%@ Page Title="" Language="C#" MasterPageFile="~/Administration.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="AdminServiceConfiguration.aspx.cs" Inherits="AdminPanel.AdminServiceConfiguration" %>
<asp:Content ID="Content1" ContentPlaceHolderID="rightpanel" runat="server">
     <script type="text/javascript">
         $("document").ready(function () {
             ...
             //$("#MailData").click(function () {
             //    $(".MailData").show()
             //    $("#MailData").addClass("active");
             //    $("#DetailData").removeClass("active");
             //    $("#HistoryData").removeClass("active");
             //    $("#CustomerData").removeClass("active");
             //    $(".DetailData_box").hide();
             ...
             $("#btnSave").click(function () {
                 ...
                 if ((ValidatePage('email_pop_box')) && EmailValidator($('#txtEmailId')[0])) {
                     ...
                     $.ajax({
                         type: "POST",
                         url: 'AdminServiceConfiguration.aspx/saveData',
    ...
    <style type="text/css">
     ...
     <input class="activeli_list" value="sidebar_adser_conf" type="hidden">
     <div class="top-header-area">
        <h2>Admin Service Configuration</h2>
    </div>
    <div class="distance_area" style="text-align: center; background: #f4f4f4;">
        <div class="outage_toggle_box">
                    <ul class="tab_nav_1 navbar-nav">
                        ...
                        <li class="web_img2 active" id="CustomerData1"><a href="#">Web config</a></li>

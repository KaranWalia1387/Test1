<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="usernameautocomplete.ascx.cs" Inherits="AdminPanel.UserControl.usernameautocomplete" %>
        ...
        try{
            ...
            $(".txtcustomername").autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        url: url1,
                        data: "{ 'prefixText': '" + request.term + "','cityid': '" + $('#ddlCity').val() + "','key': '" + $(".city option:selected").attr('key') + "','selectall': '" + selectall + "','accountno':'','searchtype': '" + $("#ddlsearchtype").val() + "'}",//#5045
                        dataType: "json",
                        type: "POST",
...
<asp:TextBox ID="txtcustomername" runat="server" style="padding-left:10px;    margin-bottom: 0px;" ClientIDMode="Static" placeholder="Customer Name" MaxLength="90" CssClass="form-control txtcustomername"></asp:TextBox>

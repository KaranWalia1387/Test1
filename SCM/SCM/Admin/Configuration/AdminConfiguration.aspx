<%@ Page Title="" Language="C#" MasterPageFile="~/Administration.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="AdminConfiguration.aspx.cs" Inherits="AdminPanel.AdminConfiguration" %>
<asp:Content ID="Content1" ContentPlaceHolderID="rightpanel" runat="server">
        ...
        $("document").ready(function () {
            ...
            $("#btnSave").click(function () {
                ...
                if ((ValidatePage('email_pop_box')) && EmailValidator($('#txtEmailId')[0])) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'AdminConfiguration.aspx/saveData',
    ...
    <style type="text/css">
        ...
        <input class="activeli_list" value="sidebar_admin_conf" type="hidden">

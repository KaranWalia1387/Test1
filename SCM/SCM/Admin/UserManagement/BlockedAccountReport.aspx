<%@ Page Title="Blocked Account" Language="C#" MasterPageFile="~/UserManagement/UserManagement.master" AutoEventWireup="true" CodeBehind="BlockedAccountReport.aspx.cs" Inherits="AdminPanel.BlockedAccountReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightpanel" runat="server">
    ...
    <script src="../js/BlockedAccountReport.js"></script>
    ...
    <div class="top-header-area">
        <div style="float: left; width: 85%;">
            <h2 style="padding-left: 20px;">Blocked Account Report</h2>
        </div>
    </div>

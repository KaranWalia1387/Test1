<%@ Page Title="Locked Users" Language="C#" MasterPageFile="~/UserManagement/UserManagement.master" AutoEventWireup="true" CodeBehind="IpInfo.aspx.cs" Inherits="AdminPanel.IpInfo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightpanel" runat="server">
    ...
    <script src="../js/UserIpInfo.js"></script>
    ...
    <div class="top-header-area">
        <div style="float: left; width: 85%;">
            <h2 style="padding-left: 20px;">Locked Customers</h2>
        </div>
    </div>

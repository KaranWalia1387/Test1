	...
	dom.getParentByTagName = function(o,tagNames) {
		...
		if (isArray(tagNames)) {
			...
			while (o=o.parentNode) {
				if (o.nodeName && contains(tagNames,o.nodeName)) {
					return o;
				}
			}
		}
...
Popup.hide = function (divId, focusID) {
...
Popup.prototype.className = "PopupcontentNew";
...
Popup.prototype.addScreen = function() {
	...
	this.screenIframeShim.style.width = Screen.getDocumentWidth()-4+"px";
	this.screenIframeShim.style.height = Screen.getDocumentHeight()-4+"px";

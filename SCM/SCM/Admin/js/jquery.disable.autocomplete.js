...
(function($) {
	...
	function disableAutocomplete() {
	  ...
	  //  $input.hide();
	    ...
	    $clone.removeAttr("id").attr("type", "password").hide();
	    $clone.removeAttr("mandatory");
	    //$clone.css({ "display": "block", "border": "0px", "width": "0px", "height": "0px", "background-color": color });
	    $input.before(
	     $clone
	    );
       ...
       // ----------------------------
		...
		//	type : "text", name : ""
		//}).on(
		//	"keypress  paste", maskAndSyncInputs //keydown  
		//);

<%@ Page Title="Notification Report" Language="C#" MasterPageFile="~/AdminReports/AdminReport.master" AutoEventWireup="true" CodeBehind="Notifications.aspx.cs" Inherits="AdminPanel.AdminReports.Notifications" %>
...
.top-header-area, .top-header-area h2 {
 ...
 .outage_graph_img {
   ...
   <div class="filter-section" id="divFilter"  style="width:97%;padding-bottom:0%;margin-left:1.4%">
            ...
            <%--<div class="input-section"><select id="ddluserzipcode" title="Zip code" disabled="disabled"></select></div>--%>
            <div class="input-section">
            ...
            <div class="input-section">
                <asp:DropDownList ID="ddlNotificationtype" runat="server" ClientIDMode="Static" ToolTip="Notification Type">
    ...
    <div class="grid-section" style="padding-top: 0px;width: 99.5%">
        ...
        <div id="chartDiv" class="Chart-area" style="position: relative; float: left; width: 100%; ">
            <div class="grid_main_box">
                ...
                <div id="div-NotificationChart" visible="true" style="width:100%; height:290px;"></div>
                <div id="nodata_div1" style="width: 100%; text-align: center" visible="false"></div>
            </div>
        </div>
    </div>
    <script src="../js/notification-report.js"></script>

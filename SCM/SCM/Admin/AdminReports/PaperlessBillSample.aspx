<%@ Page Title="Dashboard : Paperless Bill" Language="C#" MasterPageFile="~/AdminReports/AdminReport.master" AutoEventWireup="true" CodeBehind="PaperlessBillSample.aspx.cs" Inherits="AdminPanel.AdminReports.PaperlessBillSample" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightpanel" runat="server">
    <script src="../js/PaperlessBillSample.js"></script>
    ...
    <div class="right-content-area">
        ...
        <input type="hidden" class="activeli_list" value="sidebar_paperless" />
                ...
                <div class="content">
                    <div class="input-section">
                        ...
                        <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txtDateFrom" PopupPosition="BottomRight"
                            OnClientDateSelectionChanged="checkDate" PopupButtonID="txtDateFrom" />
                    </div>
                    <div class="input-section">
                        ...
                        <ajaxToolkit:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="txtDateTo" PopupPosition="BottomRight"
                            OnClientDateSelectionChanged="checkDate" PopupButtonID="txtDateTo" />
                    </div>
                    <div class="input-section">
            ...
            <ul>
                ...
                <li style="width: 33%;">
                    <div class="average_usage_header">
                        <span>
                            <asp:Label ID="lblENROLLED" runat="server" ClientIDMode="Static"></asp:Label>
                        </span>

                    </div>
                    <i>ENROLLED CUSTOMER ACCOUNTS</i>
                </li>
                    <li style="width: 33%;">
                    <div class="average_usage_header">
                        <span>
                            <asp:Label ID="lblUnerolled" runat="server" ClientIDMode="Static"></asp:Label>
                        </span>

                    </div>
                    <i>UNENROLLED CUSTOMER ACCOUNTS</i>
                </li>
                <li style="width: 33%;">
                    <div class="average_usage_header">
                        <span>
            ...
            <div class="power_graph_heading power_graph_spanish">
                ...
                <div class="lgnd_box_right">
                    <div class="left-active-sprites">
                        <ul>
                            <li class="chart"><a href="#" id="chart_pop"></a></li>
                            <li class="graph line_grph_css"><a href="#" id="graph_pop" title="Chart view" class="active"></a></li>
                        </ul>
                    </div>
                </div>
    ...
    <div id="nodata_div" style="width: 100%; text-align: center; color: Red; display: none;" visible="false">No Paperless Billing Data available</div>

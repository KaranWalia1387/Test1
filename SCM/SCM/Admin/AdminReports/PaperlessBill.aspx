<%@ Page Title="Paperless Billing Report" Language="C#" MasterPageFile="~/AdminReports/AdminReport.master" AutoEventWireup="true" CodeBehind="PaperlessBill.aspx.cs" Inherits="AdminPanel.AdminReports.PaperlessBill" %>
    ...
    <div class="top-header-area">
        ...
        <div class="filter-section" id="divFilter"  style="width:97%;padding-bottom:0%;margin-left:1.4%">
            ...
            <div class="input-section">
                <asp:TextBox ID="txtDateFrom" runat="server" placeholder="From Date" ClientIDMode="Static" style="width: 80%;" ToolTip="From date" ReadOnly="true"></asp:TextBox>
            ...
            <div class="input-section">
                <input id="txtSearch" type="text" placeholder="Search User" title="Search User"/>
            </div>
            <div class="input-section" style="width: auto  !important;">
                <asp:Button ID="btnFilter" ToolTip="Search" CssClass="filterBtn" style="margin:0px;" runat="server" OnClientClick="return false"  ClientIDMode="Static"/>
    ...
    <div class="grid-section" style="padding-top: 0px;width: 99.5%">
        ...
        <div id="chartDiv" class="Chart-area" style="position: relative; float: left; width: 100%; ">
            <div class="grid_main_box">
                ...
                <div id="PaperlessTitle" style="font-weight:  bold;"></div>
                
                <div id="div-paperlessbillChart" visible="true" style="width:100%; height:300px;"></div>
                <div id="nodata_div1" style="width: 100%; text-align: center" visible="false"></div>
            </div>
        </div>
    </div>
    
    <script src="../js/paperlessbill-report.js"></script>
</asp:Content>

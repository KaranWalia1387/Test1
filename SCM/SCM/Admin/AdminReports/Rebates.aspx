<%@ Page Title="Rebates" Language="C#" MasterPageFile="~/AdminReports/AdminReport.master" AutoEventWireup="true" CodeBehind="Rebates.aspx.cs" Inherits="AdminPanel.AdminReports.Rebates" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightpanel" runat="server">
    <script src="../js/rebates-report.js"></script>
         <script src="../js/Rebates-report.js"></script>
...
width:190px !important;
    ...
    <div class="right-content-area">
        ...
        <input class="activeli_list" value="sidebar_rebates" type="hidden">
      ...
      <!-- Edited by prashant ends (code edited for graph & grid section here ) -->
        <div class="grid-section" style="padding-top: 0px; width: 100%">
            ...
            <div id="nodata_div" style="width: 100%; text-align: center; color: Red;display: none;" visible="false">No  Rebates Data Available</div>

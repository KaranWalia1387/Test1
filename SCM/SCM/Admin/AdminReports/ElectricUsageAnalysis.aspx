<%@ Page Title="Electric Usage Analysis" Language="C#" MasterPageFile="~/AdminReports/AdminReport.master" AutoEventWireup="true" CodeBehind="ElectricUsageAnalysis.aspx.cs" Inherits="AdminPanel.AdminReports.ElectricUsageAnalysis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightpanel" runat="server">
    <script type="text/javascript">
        $("document").ready(function () {
            ...
            $('.sidebar_electricusage').addClass('active');
        });
    </script>
    <style type="text/css">
        .filterdrop {
    ...
    <div class="top-header-area">
        <div style="float: left; width: 98%;">
            <h2>Electrical Usage Analysis</h2>
    ...
    <div class="filter-section" id="divFilter" style="width: 97%; padding-bottom: 0%; margin-left: 1.4%; margin-bottom: 0px;">
        <div class="expand-one">
            ...
            <div class="content" style="height: 48px; padding-top: 7px; padding-left: 12px;">
                ...
                <div class="input-section">
                    <input type="text" id="txtCustomerName" placeholder="Customer Name" title="Customer Name" maxlength="90" />
                </div>
                ...
                <div class="dashboard-area-temp">
                    <ul>
                        <li>
                            ...
                            <%-- <h3>Total Weekend/Weekday Usage Analysis </h3>
                                    <div id="div-WeekendWeekDayChart" style="width: 100%; height: 300px !important; float: left;"></div>
                                    <h3>Total Peak/Non-Peak Usage Analysis </h3>
                                    <div id="div-PeakNonPeakChart" style="width: 100%; height: 300px !important; float: left;"></div>--%>
                        </li>
                        <li style="overflow-x:auto">
                            <h3 id="h3-TopCustomerChart">Total Electric Usage</h3>
                            <div id="time-TopCustomerChart"></div>
                            <div id="div-TopCustomerChart" style="width: 65%; height: 400px !important; float: left;"></div>
                           <%-- <div id="nodata_TotalElectric" style="width: 100%; text-align: center; color: red; display: none">No data for Total Electric Usage</div>--%>
                        </li>
                        <li style="overflow-x:auto">
                            <h3 id="h3-TotalUsageChart">Top Customers By Electric Usage</h3>
                            <div id="time-TotalUsageChart"></div>
                            <div id="div-TotalUsageChart" style="width: 65%; height: 400px !important; float: left;"></div>
                      <%--<div id="nodata_TopCustomers " style="width: 100%; text-align: center; color: red; display: none;height: 250px !important;">No data for Top Customers         By  Electric Usage</div>--%>
                        </li>
                        <li style="overflow-x:auto">
                            <h3 id="h3-TrendChart">Electric Usage Trends By Location</h3>
                            <div id="time-TrendChart"></div>
                            <div id="div-TrendChart" style="width: 65%; height: 400px !important; float: left;"></div>
                       <%--<div id="nodata_ElectricTrends " style="width: 100%; text-align: center; color: red; display: none">No data for Electric Usage Trends By Location</div>--%>
                      </li>
                    </ul>
                </div>
            </div>
    ...
    <script src="../js/Analysis-ElectricalUsage.js"></script>

<%@ Page Title="Gas Usage" Language="C#" AutoEventWireup="true" MasterPageFile="~/AdminReports/AdminReport.master" CodeBehind="GasUsage.aspx.cs" Inherits="AdminPanel.AdminReports.GasUsage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightpanel" runat="server">
    <script type="text/javascript">
        $("document").ready(function () {
            ...
            $('.sidebar_gasusage').addClass('active');
        });
    </script>
        <style type="text/css">
        .filterdrop
        ...
        <div class="dashboard-area-temp">
            <ul>
                ...
                <li style="overflow-x:auto">
                   <h3 id="h3-GasUsageChart">Usage by Time Period</h3>
                    <div id="time-GasUsageChart"></div>    
                    <div id="div-GasUsageChart" visible="true" style="width:65%; height:400px !important; float:left;"></div>
                </li>
                <li style="overflow-x:auto">
                   <h3 id="h3-TopGasUsageChart">Top Customers</h3>
                    <div id="time-TopGasUsageChart"></div>    
                    <div id="div-TopGasUsageChart" visible="true" style="width:65%; height:400px !important; float:left;"></div>
                </li>
                <li style="overflow-x:auto">
                   <h3 id="h3-GasUsageTrendChart">Usage Trend Analysis</h3>
                    <div id="time-GasUsageTrendChart"></div>    
                    <div id="div-GasUsageTrendChart" visible="true" style="width:65%; height:400px !important; float:left;"></div>
                </li>
            </ul>
         </div>
    ...
    <script src="../js/Analysis-GasUsage.js"></script>

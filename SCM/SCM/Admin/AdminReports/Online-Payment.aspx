<%@ Page Title="Online Payment" Language="C#" MasterPageFile="~/AdminReports/AdminReport.master" AutoEventWireup="true" CodeBehind="Online-Payment.aspx.cs" Inherits="AdminPanel.AdminReports.Online_Payment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightpanel" runat="server">
    ...
    <script src="../js/Online-Payment.js" type="text/javascript"></script>
...
<style type="text/css">
    ...
    <style>
     ...
     <input class="activeli_list" value="sidebar_payment" type="hidden">
    ...
    <div class="top-header-area">
     ...
     <div class="filter-section" id="divFilter" style="display: none; width: 100%; padding-bottom: 0%; margin-left: 0%; margin-bottom: 0px;">
             <div class="expand-one">
                <p class="filter_section_link" style="display:none;"><img class="imgtoggle" src="Usage%20Report_files/a.png">Filter</p>
                    <div class="content">
                ...
                <ul>
                  <%--  <li style="width: 33.3%;">
                    <div class="average_usage_header">
                        <span>
                            <asp:Label ID="lblBillPaid" runat="server" ClientIDMode="Static"></asp:Label>
                        </span>

                    </div>
                    <i>Online Bill Paid</i>
                </li>

                <li style="width: 33.3%;">
                    <div class="average_usage_header">
                        <span>
                            <asp:Label ID="lblTotalBill" runat="server" ClientIDMode="Static"></asp:Label>
                        </span>
                    </div>
                    <i>Total Bill</i>
                </li>--%>
                    ...
                    <div class="average_usage_header">
                        <span>
                            <asp:Label ID="lbltotalTrans" runat="server" ClientIDMode="Static"></asp:Label>
                        </span>
                    </div>
                    <i>Online Payments</i>
                </li>
    ...
    <div class="power_graph_heading power_graph_spanish">
      ...
      <div id="nodata_div" style="width: 100%; text-align: center;display:none">
          <font color="red">No Online Payment Data available</font>
      </div>
                          ...
                          <div class="modal-body">
                             <div class="pdf_box_wrapper">
                             	<b>Please select file type(s) to export</b>
                             		<ul>
                                          <li><a href="#" id="pdf" class="pdf_icon" runat="server" onserverclick="pdf_ServerClick">Pdf(.pdf)</a></li>

<%@ Page Title="Programs" Language="C#" MasterPageFile="~/AdminReports/AdminReport.master" AutoEventWireup="true" CodeBehind="Programs.aspx.cs" Inherits="AdminPanel.AdminReports.Programs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightpanel" runat="server">
    <script src="../js/programs-report.js"></script>
...
width:190px !important;
    ...
    <div class="right-content-area">
        ...
        <input class="activeli_list" value="sidebar_programs" type="hidden">
        ...
        <div class="top-header-area">
            ...
            <ul>
                <li aria-disabled="true"><a id="idExcel" href="#" data-toggle="modal" data-target="#export_docs_pop" title="Export"><span class="fa fa-external-link icon_color"></span> Export</a></li>                                     
        ...
        <div style="display: block; width: 100%;" class="current_area" id="GenDiv">
            <ul>
                ...
                <li style="width: 33.3%;">
                    ...
                    <i>APPROVED REQUESTS</i>
                </li>

                <li style="width: 33.3%;">
                    <div class="average_usage_header">
                        <span>
                            <asp:Label ID="lblPending" runat="server" ClientIDMode="Static"></asp:Label>
                        </span>
                    </div>
        ...
        <div id="nodata_div" style="width: 100%; text-align: center; color: Red;display: none;" visible="false">No Programs  Data Available</div>
                </div>
                ...
                <div class="modal-body">
                    <div class="pdf_box_wrapper">
                        ...
                        <ul>
                            ...
                            <li><a href="#" class="excel_icon" id="btnExcelExport1" runat="server" onserverclick="btnExcelExport1_ServerClick">Excel(.xls)</a></li>
                        </ul>
                    </div>

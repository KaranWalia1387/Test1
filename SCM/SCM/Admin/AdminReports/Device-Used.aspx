<%@ Page Title="Device Used" Language="C#" MasterPageFile="~/AdminReports/AdminReport.master" AutoEventWireup="true" CodeBehind="Device-Used.aspx.cs" Inherits="AdminPanel.AdminReports.Device_Used" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightpanel" runat="server">
    ...
    <input class="activeli_list" value="sidebar_device" type="hidden">
    ...
    <div style="display: block; width: 100% !important;" class="current_area" id="GenDiv">
        <ul>
            <li>
                ...
                <i id="demandusagetext" style="text-transform: none !important">iOS DEVICES</i>
            </li>
            <li>
                <div class="average_usage_header"><span id="Android">0</span><%--<img src="../Usage Report_files/arrow_down_img.png">--%></div>
                <i id="androidText">ANDROID DEVICES</i>
            </li>

            <li>
                <div class="average_usage_header"><span id="Total">0</span><%--<img src="../Usage Report_files/arrow_up_img.png">--%></div>
                <i id="totalText">TOTAL DEVICES</i>
            </li>
        </ul>
    </div>
    ...
    <div id="nodata_div" style="width: 100%; text-align: center; display: none">
        <font color="red">No Device Used Data available</font>
    </div>
    ...
    <%--    //]]>--%>
 <script src="../js/device-used.js"></script>

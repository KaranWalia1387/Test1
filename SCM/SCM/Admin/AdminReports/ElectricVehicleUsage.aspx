<%@ Page Title="Electric Vehical Usage" Language="C#" AutoEventWireup="true" MasterPageFile="~/AdminReports/AdminReport.master" CodeBehind="ElectricVehicleUsage.aspx.cs" Inherits="AdminPanel.AdminReports.ElectricVehicleUsage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightpanel" runat="server">
    <script type="text/javascript">
        $("document").ready(function () {
            ...
            $('.sidebar_evusage').addClass('active');
        });
    </script>
        <style type="text/css">
        .filterdrop
    ...
    <div class="top-header-area">
        <div style="float: left; width: 98%;">
            <h2>Electric Vehicle Usage Analysis</h2>
        ...
        <div class="expand-one">
            ...
            <div class="content" style="height: 48px; padding-top: 7px; padding-left: 12px;">
                <div class="input-section">
                    <asp:TextBox ID="txtDateFrom" runat="server" placeholder="From Date" ClientIDMode="Static" Style="width: 90%;" ToolTip="From date"></asp:TextBox>
                ...
                <div class="input-section">
                    <asp:TextBox ID="txtDateTo" runat="server" placeholder="To Date" ClientIDMode="Static" Style="width: 90%;" ToolTip="To date"></asp:TextBox>
        ...
        <div class="dashboard-area-temp">
            <ul>
                ...
                <li style="overflow-x:auto">
                   <h3 id="h3-EVUsageChart">Usage by Time Period</h3>
                    <div id="time-EVUsageChart"></div>    
                    <div id="div-EVUsageChart" visible="true" style="width:100%; height:400px !important; float:left;"></div>
                </li>
                <li style="overflow-x:auto">
                   <h3 id="h3-TopEVUsageChart">Top Customers</h3>
                    <div id="time-TopEVUsageChart"></div>    
                    <div id="div-TopEVUsageChart" visible="true" style="width:100%; height:400px !important; float:left;"></div>
                </li>
                <li style="overflow-x:auto">
                   <h3 id="h3-EVCountChart"><%--Electriv Vehicle Count--%>
                       Electric Vehicles By Zip Code <%--changes according to sheet--%>
                   </h3>
                    <div id="time-EVCountChart"></div>    
                    <div id="div-EVCountChart" visible="true" style="width:100%; height:400px !important; float:left;"></div>
                </li>
                <li>
                   <h3>Usage Trend Analysis</h3>
                    <div id="time-EVUsageTrendChart"></div>    
                    <div id="div-EVUsageTrendChart" visible="true" style="width:100%; height:400px !important; float:left;"></div>
                </li>
            </ul>
         </div>
                        </div>
            </div>
        <div id="mapDiv" class="Map-div" style="display: none;"></div>
    </div>
        </div>
    <script src="../js/Analysis-ElectricVehicleUsage.js"></script>

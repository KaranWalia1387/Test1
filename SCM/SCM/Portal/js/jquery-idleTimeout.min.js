...
(function ($) {
    ...
    $.fn.idleTimeout = function (userRuntimeConfig) {
        ...
        this.logout = function () {
            store.set('idleTimerLoggedOutPortalV6', true);
        };
        ...
        checkIdleTimeout = function () {
            ...
            var timeIdleTimeout = (store.get('idleTimerLastActivityPortalV6') + (currentConfig.idleTimeLimit * 1000));

            if ($.now() > timeIdleTimeout) {
                if (store.get('idleTimerLastActivityPortalV6') == 0) {
            ...
            } else if (store.get('idleTimerLoggedOutPortalV6') === true) { //a 'manual' user logout?
                logoutUser();
            } else {
        ...
        startIdleTimer = function () {
            stopIdleTimer();
            store.set('idleTimerLastActivityPortalV6', $.now());
        ...
        checkDialogTimeout = function () {
            var timeDialogTimeout = (store.get('idleTimerLastActivityPortalV6') + (currentConfig.idleTimeLimit * 1000) + (currentConfig.dialogDisplayLimit * 1000));

            if (($.now() > timeDialogTimeout) || (store.get('idleTimerLoggedOutPortalV6') === true)) {
                logoutUser();
            }
        };
        ...
        return this.each(function () {
            ...
            if (store.enabled) {
                ...
                store.set('idleTimerLastActivityPortalV6', $.now());
                store.set('idleTimerLoggedOutPortalV6', false);

...
(function ($) {
	...
	loadYoumax = function() {	
		...
		$('#youmax').append('<div id="youmax-encloser"><iframe id="youmax-video" width="640" height="360" src="" frameborder="0" allowfullscreen></iframe><div id="youmax-video-list-div"></div><div id="youmax-load-more-div">LOAD MORE</div></div>');
	...
	getChannelDetails = function(channelId) {
		...
		//var apiProfileURL = "gdata.youtube.com/feeds/api/users/"+youmaxUser+"?v=2&alt=json";
	...
	showUploads = function(response,playlistTitle,loadMoreFlag) {
		...
		$('.youmax-video-tnail-box').click(function(){
			//console.log(this.id);
			//console.log(showVideoInLightbox);
	...
	getUploads = function(youmaxTabId,playlistTitle,nextPageToken) {
		//showLoader();
		//var apiUploadURL = "gdata.youtube.com/feeds/api/users/"+youmaxUser+"/uploads/?v=2&alt=jsonc&max-results=50";
	...
	getPlaylists = function(nextPageToken) {
		...
		//var apiPlaylistURL = "gdata.youtube.com/feeds/api/users/"+youmaxUser+"/playlists?v=2&alt=jsonc&max-results=50";	
		$.ajax({

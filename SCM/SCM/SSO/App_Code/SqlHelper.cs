...
//Public NotInheritable Class SqlHelper
    ...
    public sealed class SqlHelper
    {
        ...
        {
            //string myConnString = @"DATA SOURCE = PRACHIN-4205581;initial catalog = SSA;Integrated security = true";
            //string myConnString = @"DATA SOURCE = USER-PC;initial catalog = smartusys;Integrated security = true";
            string myConnString = ConfigurationManager.AppSettings["ConnectionString"];
            
            return myConnString;
        }

        /// <summary>
        /// Gets the connectionstring with given key
        /// </summary>
        /// <returns></returns>
        public static string GetConnectionString(string key)
        {
            //string myConnString = @"DATA SOURCE = PRACHIN-4205581;initial catalog = SSA;Integrated security = true";
            //string myConnString = @"DATA SOURCE = USER-PC;initial catalog = smartusys;Integrated security = true";
            string myConnString = ConfigurationManager.AppSettings[key];           
        ...
        public static DataSet ExecuteDataSet(string commandText, params SqlParameter[] commandParameters)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                return ExecuteDataSet(connection, CommandType.StoredProcedure, commandText, commandParameters);
            }
        }
